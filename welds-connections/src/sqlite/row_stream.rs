...
pub(crate) struct SqliteRowStream<'e> {
    sql: String,
    inner_stream: Option<BoxStream<'e, Result<Row>>>,
}

impl<'e> SqliteRowStream<'e> {
        ...
        'params: 'e,
    {
        ...
        let mut query = sqlx::query::<Sqlite>(sql_str_self_ref);
        for param in params {
...
impl<'e> Stream for SqliteRowStream<'e> {
